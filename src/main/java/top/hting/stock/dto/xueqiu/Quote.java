...
public class Quote implements Serializable {
    private Object currentExt; // 扩展的当前值（如果有）
    private String symbol; // 股票代码
    private Object volumeExt; // 扩展的成交量（如果有）
    ...
    private Object noProfit; // 无盈利指标（如果有）
    private BigDecimal high; // 当天最高价
    private BigDecimal floatMarketCapital; // 流通市值
    private Object timestampExt; // 扩展的时间戳（如果有）
    private Integer lotSize; // 每手股数
    private Object lockSet; // 锁定集合（如果有）
    private Object weightedVotingRights; // 加权投票权益（如果有）
    ...
    private Object noProfitDesc; // 无盈利指标的描述（如果有）
    ...
    private Object pledgeRatio; // 质押比例（如果有）
    private Object tradedAmountExt; // 扩展的成交金额（如果有）
